...
console.log(roundToNext(-5), -5)
console.log(roundToNext(3), 5)
console.log(roundToNext(5), 5)
console.log(roundToNext(7), 10)
console.log(roundToNext(20), 20)
console.log(roundToNext(39), 40)
console.log(roundToNext(990), 990)
console.log(roundToNext(121), 125)
console.log(roundToNext(555), 555)